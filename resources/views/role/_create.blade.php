<div class="modal fade" id="addRoleModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="exampleModalLabel">Agregar {{ __('Role') }}</h5>
            ...
            <form action="#" method="POST" id="add_role_form" enctype="multipart/form-data">
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" id="add_role_btn" class="btn btn-outline-primary rounded-0">Agregar {{ __('Role') }}</button>
                </div>
            </form>
        </div>
    </div>
